 ...
 */
//总条数
$sqla='select count(*) from '.PREFIX.'users';
...
$sql="select * from ".PREFIX."users order by id {$limit}";  //asc 升序 desc降序
...
?>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderbottom"><a href="./edit.php?id=<?php echo $row['id'] ?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span><a href="../useraction.php?a=delete&id=<?php echo $row['id'] ?>" target="mainFrame" onFocus="this.blur()" class="add" onclick="return confirm('确定删除用户吗?')">删除</a></td>
      </tr>
<?php
