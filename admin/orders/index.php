...
//分页
//总条数
$sqlmax="select count(*) as total from ".PREFIX."orders as o,".PREFIX."users as u where o.uid=u.id";
...
$sql="select o.*,u.username from ".PREFIX."orders as o,".PREFIX."users as u where o.uid=u.id order by id desc {$limit}";
//echo $sql;die;
...
?>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo $row['linkman'] ?></td>
        ...
        <td align="center" valign="middle" class="borderright borderbottom"><a href="./detail_search.php?wd=<?php echo $row['userorder'] ?> "><?php echo $row['userorder'] ?></a></td>
