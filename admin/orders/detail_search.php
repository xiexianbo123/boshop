...
//设置where like语句
$where="where userorder like '%{$wd}%'";

//分页
//总条数
$sqlmax="select count(*) as total from ".PREFIX."detail {$where}";
...
//遍历输出订单详情
$sql="select * from ".PREFIX."detail {$where} order by id desc {$limit}";
$result = myQuery($sql);
...
?>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderbottom"><?php echo reg_search($wd,$value['userorder']); ?></td>
      </tr>
...
?>
  ...
  <tr>
    <td align="left" valign="top" class="fenye"><?php echo $count; ?> 条数据 <?php echo $page ?>/<?php echo $countPage; ?> 页&nbsp;&nbsp;<a href="./detail_search.php?wd=<?php echo $wd; ?>&page=1" target="mainFrame" onFocus="this.blur()">首页</a>&nbsp;&nbsp;<a href="./detail_search.php?wd=<?php echo $wd; ?>&page=<?php echo  ($page-1)<1 ? '1' : $page-1; ?>" target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;<a href="./detail_search.php?wd=<?php echo $wd; ?>&page=<?php echo ($page+1)>$countPage ? $countPage : $page+1; ?>" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;<a href="./detail_search.php?wd=<?php echo $wd; ?>&page=<?php echo $countPage; ?>" target="mainFrame" onFocus="this.blur()">尾页</a></td>
  </tr>
</table>
</body>
</html>