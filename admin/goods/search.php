...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：商品搜索</td>
  </tr>
  <tr>
...
//设置where like语句
$where="where goods like '%{$wd}%'";

//分页
//总条数
$sqla="select count(*) from ".PREFIX."goods {$where}";
//echo $sqla;die();
...
$where="g.goods like '%{$wd}%'";

$limit='limit '.($page-1)*$num.','.$num;
//如何两张表同时查询且可以插入like条件呢?
$sql = "select g.*,t.name from ".PREFIX."goods as g,".PREFIX."type as t where g.typeid=t.id and {$where} order by g.id desc {$limit}";
//echo $sql;die();
...
?>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo reg_search($wd,$row['goods']); ?></td>
