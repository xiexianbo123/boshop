...
?>
		...
		<div class="pro-cate-attr clearfix">
			...
			<div class="p-default">
				<ul>
                    <li id="first-category" ><a href="list.php?id=<?php echo $typeRes['parent']; ?>">全部</a></li>
			...
			<div class="p-values">
				...
				<div class="p-expand">
					<ul class="clearfix">
<?php
foreach($typeRes['child'] as $val){
	 echo '<li ><a href="list.php?id='.$val['id'].'">'.$val['name'].'</a></li>';
}
 ?>
<!--
	                    <li ><a href="#">荣耀</a></li>
...
-->
			...
			<div id="pro-cate-attr-100113" class="pro-cate-attr clearfix">
			    ...
			    <div class="p-default">
				    <ul>
					    <li id="pro-cate-attr-all"><a href="#" onclick="ec.product.chooseAttrAllValue(100113)">全部</a></li>
				    </ul>
			    </div>
...
<textarea id="product-arrival-html" class="hide">
    ...
    <div class="channel-list">
		...
		<div class="pro-list clearfix">
			<ul>
<?php
$idStr=listIdData($id,$result110);

//遍历数据
$sqldd="select * from ".PREFIX."goods where typeid in({$idStr}) and state=2";
//echo $sql;die;
